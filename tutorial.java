...
public class Tutorial {
	...
	public static void main(String[] args) {
		...
		for(int i = 0;i<50;i++) {
			...
			Activity a2 = popFac.createActivityFromCoord("work", new Coord(1520, 520));
			plan.addActivity(a1);
			plan.addLeg(leg);
			plan.addActivity(a2);
			person.addPlan(plan);
		...
		s2.setStrategyName(DefaultSelector.BestScore);
		s2.setWeight(0.9);
		...
		config.qsim().setStartTime(10*3600);
